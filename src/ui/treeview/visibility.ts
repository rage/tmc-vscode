...
export class Visibility {
   ...
   */
  public registerAction(id: string, groups: (VisibilityGroup | VisibilityGroupNegated)[]): void {
   ...
   */
  public setGroupVisible(group: VisibilityGroup | VisibilityGroupNegated): [string, boolean][] {
