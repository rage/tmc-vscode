...
export function decorateCompletedExercises(actionContext: ActionContext): void {
    const { exerciseDecorator, vsc, resources } = actionContext;
    exerciseDecorator.provideDecoration(vsc.toUri(resources.getExercisesFolderPath()));
}
