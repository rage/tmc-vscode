 ...
 *
 * @returns The picked course, or `undefined` if there are no courses or the pick was
 * dismissed. Picking yields a {@link CourseIdentifier} unless `value` says otherwise.
 */
